...
if(size>10){
   $(function (){
      ...
      for(i=0;i<ssize;i++){
         $('#num_2').append("<div id='a"+(i+1)+"' style='margin: 0 auto; text-decoration: none; width: 30px; height: 20px; cursor:pointer' onclick='number_click("+(i+1)+")'>"+(i+1)+"</div>");
         $("#num_2").append("<form action='acnotice' method='post' name='numbtn"+(i+1)+"'>"
   ...
   <!-- 검색 form -->
    ...
    <div align="center">
    	<div style="display: flex; flex-flow:low; margin-bottom: 50px; justify-content: center;align-items: center;" align="center">
           ...
           <form action="acnotice_search" name="list_form" method="post">
